...
//		int Line_Count(char const * section) const;
		...
		*/
		...
		const WideStringClass& Get_Wide_String(WideStringClass& new_string, char const * section, char const * entry, unsigned short const * defvalue=reinterpret_cast<const unsigned short*>(L"")) const;
