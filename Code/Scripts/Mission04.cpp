			...
			case ACTION_COMPLETE_CONVERSATION_ENDED: //
				{
					...
					else if (action_id == missileConv) //sabotage missile racks  M04_Add_MissileRoom_Objective_Conversation_02
					{
						...
						Commands->Join_Conversation( NULL, missileConv02, false, false , false);
					...
					else if (action_id == prisonKeyIntroConv) //get prison key from guard
					{
						...
						Commands->Join_Conversation( NULL, medlab_conv, false, true , false);
...
***********************************************************************************************************/
		...
		if (type == 0)
		{
			...
			else if (param == announce_prison_guard_objective)
			{
				...
				Commands->Join_Conversation( NULL, prisonKeyIntroConv, false, false , false);
			...
			else if (param == announce_engine_room_objective)
			{
				...
				Commands->Join_Conversation( NULL, engineIntroConv, false, false , false);
				//Commands->Join_Conversation( STAR, engineIntroConv, false, false , false);
			...
			else if (param == announce_missile_room_objective)//
			{
				...
				Commands->Join_Conversation( NULL, missileConv, false, false , false);
			...
			else if (param == announce_first_mate_objective && first_mate_primary_active != true && first_mate_primary_triggered == false)//
			{
				...
				Commands->Join_Conversation( NULL, firstmateConv, false, false , false);
			...
			else if (param == announce_captain_objective)//M04_Add_Captains_Key_Objective_Conversation
			{
				...
				Commands->Join_Conversation( NULL, captainConv, false, false , false);
			...
			else if (param == announce_get_back_to_sub)//
			{
				...
				Commands->Join_Conversation( NULL, protectPOWsConv, false, false , false);
...
***********************************************************************************************************/
			...
			else if (param == completed_captain_objective)
			{
				...
				if (prisoner_primary_active == false)
				{
					...
					Commands->Join_Conversation( NULL, reminderConv, false, false , false);
		...
		if (complete_reason == ACTION_COMPLETE_NORMAL)
		{
			if (action_id == M01_WALKING_WAYPATH_01_JDG)
			{
				...
				if (guardOne != NULL)
				{
					...
					Commands->Join_Conversation( obj, cargo_conv2, false, false , false);
					Commands->Join_Conversation( guardOne, cargo_conv2, false, false , false);
		...
		if (param == M01_START_ACTING_JDG && engineDestroyed == false)//controller is telling you to start acting
		{
			if (obj)
			{
				...
				if (obj && guard02 != NULL )
				{
					...
					Commands->Join_Conversation( obj, haze_prisoner_conv, false, false , false);
					Commands->Join_Conversation( guard02, haze_prisoner_conv, false, false , false);
...
DECLARE_SCRIPT(M04_Firefight_Prisoner, "")
{
	...
	void Damaged( GameObject * obj, GameObject * damager, float amount ) 
	{
		...
		if (((myCurrentHealth/myMaxHealth) * 100 ) <= 50)
		{
			if (warningPlayed == false)
			{
				...
				Commands->Join_Conversation( NULL, medlabConversation, false, true , false);
				//Commands->Join_Conversation( medTech, medlabConversation, false, true , false);
				Commands->Start_Conversation( medlabConversation, medlabConversation );
			}
		}
	...
	void Poked( GameObject * obj, GameObject * poker ) 
	{
		if (rallying == false && pokable == true)
		{
			...
			Commands->Join_Conversation( STAR, medlabConversation, false, true , false);
			//Commands->Join_Conversation( medTech, medlabConversation, false, true , false);
			Commands->Start_Conversation( medlabConversation, medlabConversation );
...
DECLARE_SCRIPT(M04_BigSam_Script_JDG, "")//104873
{
	...
	void Custom( GameObject * obj, int type, int param, GameObject * sender ) 
	{
		if (type == CUSTOM_EVENT_SOUND_ENDED  )
		{
			if (param == civWarning)
			{
				Commands->Set_Animation ( obj, "DSP_L4GIANTGUN.DSP_L4GIANTGUN", false, NULL, 0, 119 , true);
			...
			else if (param == missileStuckSound)
			{
				...
				Commands->Set_Animation ( obj, "DSP_L4GIANTGUN.DSP_L4GIANTGUN", false, NULL, 120, 200 , true);
				Commands->Set_Health ( obj, 0.25f );
			}
		}
