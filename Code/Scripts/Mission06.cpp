...
DECLARE_SCRIPT(M06_WarRoom_Computer, "")
{
	...
	void Poked(GameObject * obj, GameObject * poker)
	{
		if (Commands->Is_A_Star(poker) && (!already_poked))
		{
			...
			int conv_id = Commands->Create_Conversation (conv_name, 100.0f, 200.0f, false);
			Commands->Join_Conversation(NULL, conv_id, true, true, false);
			Commands->Join_Conversation(STAR, conv_id, false, true, false);
...
DECLARE_SCRIPT(M06_MidtroB_Explosion_Controller, "Loc0_ID=0:int, Loc1_ID=0:int, Loc2_ID=0:int, Loc3_ID=0:int, Loc4_ID=0:int")
{
	void Custom (GameObject * obj, int type, int param, GameObject * sender)
	{
		if(type == M06_MIDTRO_EXPLOSION)
		{
			...
			Commands->Create_Explosion("Chateau_Explosions_Twiddler", Commands->Get_Position(Commands->Find_Object(explode_loc[param])), nullptr);
		}
	}
};
...
DECLARE_SCRIPT(M06_GDI_Prisoner, "")
{
	...
	void Poked(GameObject * obj, GameObject * poker)
	{
		if ((Commands->Is_A_Star(poker)) && (!conversation) && (!poked))
		{
			...
			int conv_id = Commands->Create_Conversation (conv_name, 100.0f, 200.0f, false);
			Commands->Join_Conversation(obj, conv_id, false, true, false);
			Commands->Join_Conversation(poker, conv_id, false, true, false);
...
DECLARE_SCRIPT(M06_Activate_Secret_Door, "Secret_Door_ID=0:int")
{
	...
	void Poked(GameObject * obj, GameObject * poker)
	{
		if (Commands->Is_A_Star(poker) && (!already_poked))
		{
			...
			int conv_id = Commands->Create_Conversation (conv_name, INNATE_PRIORITY_ENEMY_SEEN + 5, 500.0f, true);
			Commands->Join_Conversation(STAR, conv_id, false, true, false);
...
DECLARE_SCRIPT(M06_Gate_Guards, "Soldier_ID=0:int")
{
			...
			case 1:
				{
					if(Commands->Find_Object(101021))
					{
						...
						Commands->Join_Conversation(obj, conv_id, false, true, false);
						Commands->Join_Conversation(Commands->Find_Object(110908), conv_id, false, true, false);
	...
	void Killed (GameObject * obj, GameObject * killer)
	{
		...
		/*	const char * conv_name[6];
			...
			int conv_id = Commands->Create_Conversation (conv_name[random], 50, 500.0f, true);
			Commands->Join_Conversation(NULL, conv_id, false, true, false);
			Commands->Start_Conversation (conv_id, 1);*/
	...
	void Custom (GameObject * obj, int type, int param, GameObject * sender)
	{
		...
		if(type == M06_START_CONVERSATION)
		{
			if(Commands->Find_Object(101356))
			{
				...
				int conv_id = Commands->Create_Conversation (conv_name, 50, 500.0f, true);
				Commands->Join_Conversation(obj, conv_id, false, true, false);
				Commands->Join_Conversation(Commands->Find_Object(101356), conv_id, false, true, false);
				Commands->Start_Conversation (conv_id, 10);
				Commands->Monitor_Conversation (obj, conv_id);
			}
		}
	...
	void Custom (GameObject * obj, int type, int param, GameObject * sender)
	{
		...
		if(type == M06_START_CONVERSATION)
		{
			...
			if(Commands->Find_Object(101358))
			{
				...
				int conv_id = Commands->Create_Conversation (conv_name, 50, 500.0f, true);
				Commands->Join_Conversation(obj, conv_id, false, true, false);
				Commands->Join_Conversation(Commands->Find_Object(101358), conv_id, false, true, false);
				Commands->Start_Conversation (conv_id, 10);
				Commands->Monitor_Conversation (obj, conv_id);
			}
		}
	...
	void Custom (GameObject * obj, int type, int param, GameObject * sender)
	{
		...
		if(type == M06_START_CONVERSATION)
		{
			if(Commands->Find_Object(101366))
			{
				...
				int conv_id = Commands->Create_Conversation (conv_name, 50, 500.0f, true);
				Commands->Join_Conversation(obj, conv_id, false, true, false);
				Commands->Join_Conversation(Commands->Find_Object(101366), conv_id, false, true, false);
				Commands->Start_Conversation (conv_id, 10);
				Commands->Monitor_Conversation (obj, conv_id);
			}
		}
	...
	void Custom (GameObject * obj, int type, int param, GameObject * sender)
	{
		...
		if(type == M06_START_CONVERSATION)
		{
			if(Commands->Find_Object(101370))
			{
				...
				int conv_id = Commands->Create_Conversation (conv_name, 50, 500.0f, true);
				Commands->Join_Conversation(obj, conv_id, false, true, false);
				Commands->Join_Conversation(Commands->Find_Object(101370), conv_id, false, true, false);
				Commands->Start_Conversation (conv_id, 10);
				Commands->Monitor_Conversation (obj, conv_id);
			}
		}
...
DECLARE_SCRIPT(M06_KaneHead, "")
{
	...
	void Created (GameObject * obj)
	{
		...
		int conv_id = Commands->Create_Conversation (conv_name, INNATE_PRIORITY_ENEMY_SEEN - 5, 500.0f, true);
		Commands->Join_Conversation(obj, conv_id, false, true, false);
		Commands->Join_Conversation(Commands->Find_Object(101008), conv_id, false, true, false);
		Commands->Start_Conversation (conv_id, 300123);
		Commands->Monitor_Conversation (obj, conv_id);	
	}
	...
	void Custom (GameObject * obj, int type, int param, GameObject * sender)
	{
		...
		if(type == M06_START_CONVERSATION)
		{
			if(Commands->Find_Object(101375))
			{
				...
				int conv_id = Commands->Create_Conversation (conv_name, 50, 500.0f, true);
				Commands->Join_Conversation(obj, conv_id, false, true, false);
				Commands->Join_Conversation(Commands->Find_Object(101375), conv_id, false, true, false);
				Commands->Start_Conversation (conv_id, 10);
				Commands->Monitor_Conversation (obj, conv_id);
			}
		}
	...
	void Custom (GameObject * obj, int type, int param, GameObject * sender)
	{
		...
		if(type == M06_START_CONVERSATION)
		{
			if(Commands->Find_Object(101384) && Commands->Find_Object(101385))
			{
				...
				int conv_id = Commands->Create_Conversation (conv_name, 50, 500.0f, true);
				Commands->Join_Conversation(obj, conv_id, false, true, false);
				Commands->Join_Conversation(Commands->Find_Object(101384), conv_id, false, true, false);
				Commands->Join_Conversation(Commands->Find_Object(101385), conv_id, false, true, false);
				Commands->Start_Conversation (conv_id, 10);
				Commands->Monitor_Conversation (obj, conv_id);
			}
		}
	...
	void Custom (GameObject * obj, int type, int param, GameObject * sender)
	{
		...
		if(type == M06_START_CONVERSATION)
		{
			if(Commands->Find_Object(101503))
			{
				...
				int conv_id = Commands->Create_Conversation (conv_name, 50, 500.0f, true);
				Commands->Join_Conversation(obj, conv_id, false, true, false);
				Commands->Join_Conversation(Commands->Find_Object(101503), conv_id, false, true, false);
				Commands->Start_Conversation (conv_id, 10);
				Commands->Monitor_Conversation (obj, conv_id);
			}
		}
	...
	void Custom (GameObject * obj, int type, int param, GameObject * sender)
	{
		...
		if(type == M06_START_CONVERSATION)
		{
			if(Commands->Find_Object(101391))
			{
				...
				int conv_id = Commands->Create_Conversation (conv_name, 50, 500.0f, true);
				Commands->Join_Conversation(obj, conv_id, false, true, false);
				Commands->Join_Conversation(Commands->Find_Object(101391), conv_id, false, true, false);
				Commands->Start_Conversation (conv_id, 10);
				Commands->Monitor_Conversation (obj, conv_id);
			}
		}
	...
	void Custom (GameObject * obj, int type, int param, GameObject * sender)
	{
		...
		if(type == M06_START_CONVERSATION)
		{
			if(Commands->Find_Object(101399))
			{
				...
				int conv_id = Commands->Create_Conversation (conv_name, 50, 500.0f, true);
				Commands->Join_Conversation(obj, conv_id, false, true, false);
				Commands->Join_Conversation(Commands->Find_Object(101399), conv_id, false, true, false);
				Commands->Start_Conversation (conv_id, 10);
				Commands->Monitor_Conversation (obj, conv_id);
			}
		}
