...
DECLARE_SCRIPT (M00_VisceroidInnate_DAY, "")
{
	...
	{	
		Commands->Set_Loiters_Allowed( obj, false );
		Commands->Set_Animation( obj, "C_Visceroid.C_Visceroid", true, NULL, 0.0f, -1.0f, true );
	}

	void Killed( GameObject *obj, GameObject *killer )
	{
		Commands->Set_Animation( obj, "C_Visceroid.C_Visceroid_Die", false, NULL, 0.0f, -1.0f, true );
	}
...
DECLARE_SCRIPT (M00_PlayAnimation_DestroyObject_DAY, "AnimationName:string")
{
	...
	void Created( GameObject * obj )
	{
		...
		Commands->Set_Animation( obj, animname, false, NULL, 0.0f, -1.0f, true );
	}
