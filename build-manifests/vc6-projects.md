...
Generated from the original EA Visual Studio 6 `.dsw` / `.dsp` files.
...
### `Code/BandTest/BandTest.dsw`

| Project | DSP path | Dependencies |
| --- | --- | --- |
| `BandTest` | `./BandTest.dsp` |  |
...
| Project | DSP path | Dependencies |
| --- | --- | --- |
| `RenegadeGR` | `./RenegadeGR.dsp` |  |

### `Code/Tools/VerStamp/VerStamp.dsw`

| Project | DSP path | Dependencies |
| --- | --- | --- |
| `VerStamp` | `./VerStamp.dsp` |  |

### `Code/Tools/W3DView/W3DView.dsw`

| Project | DSP path | Dependencies |
| --- | --- | --- |
| `W3DView` | `./W3DView.dsp` | ww3d2, WWAudio, wwdebug, wwlib, wwmath, wwsaveload |
...
| `GameSpy` | `./GameSpy/GameSpy.dsp` |  |
| `LevelEdit` | `./Tools/LevelEdit/LevelEdit.dsp` |  |
| `SControl` | `./SControl/SControl.dsp` |  |
| `Scripts` | `./Scripts/Scripts.dsp` |  |
| `WWAudio` | `./WWAudio/WWAudio.dsp` |  |
| `WWConfig` | `./Tools/WWConfig/WWConfig.dsp` |  |
| `WWCtrl` | `./Tools/WWCtrl/WWCtrl.dsp` |  |
| `commando` | `./Commando/commando.dsp` | Scripts, wwdebug, wwlib, wwmath, wwnet, wwphys, wwutil, WWAudio, wwsaveload, Combat, wwtranslatedb, wwbitpack, ww3d2, wwui, BinkMovie, BandTest, SControl, GameSpy |
| `max2w3d` | `./Tools/max2w3d/max2w3d.dsp` |  |
| `ww3d2` | `./ww3d2/ww3d2.dsp` |  |
...
| Project | DSP path | Dependencies |
| --- | --- | --- |
| `AMC_imp` | `./Tools/AMC_IMP/AMC_IMP.dsp` |  |
| `Blender2` | `./Tools/Blender2/Blender2.dsp` |  |
| `ChunkView` | `./Tools/ChunkView/ChunkView.dsp` |  |
| `Clipbord` | `./Tools/Clipbord/Clipbord.dsp` |  |
| `CommandoUpdate` | `./Tools/CommandoUpdate/CommandoUpdate.dsp` |  |
| `CopyLocked` | `./Tools/CopyLocked/CopyLocked.dsp` |  |
| `LevelEdit` | `./Tools/LevelEdit/LevelEdit.dsp` |  |
| `LightMap` | `./Tools/LightMap/LightMap.dsp` |  |
| `MakeMix` | `./Tools/MakeMix/MakeMix.dsp` |  |
| `MaxFly` | `./Tools/MaxFly/MaxFly.dsp` |  |
| `MixViewer` | `./Tools/MixViewer/MixViewer.dsp` |  |
| `RenRem` | `./Tools/RenRem/RenRem.dsp` |  |
| `SimpleGraph` | `./Tools/SimpleGraph/SimpleGraph.dsp` |  |
| `SkeletonHack` | `./Tools/SkeletonHack/SkeletonHack.dsp` |  |
| `VerStamp` | `./Tools/VerStamp/VerStamp.dsp` |  |
| `VidInit` | `./Tools/vidinit/VidInit.dsp` |  |
| `ViewTrans` | `./Tools/ViewTrans/ViewTrans.dsp` |  |
| `W3DShellExt` | `./Tools/W3DShellExt/W3DShellExt.dsp` |  |
| `W3DUpdate` | `./Tools/W3DUpdate/W3DUpdate.dsp` |  |
| `W3DView` | `./Tools/W3DView/W3DView.dsp` |  |
| `WWConfig` | `./Tools/WWConfig/WWConfig.dsp` |  |
| `WWCtrl` | `./Tools/WWCtrl/WWCtrl.dsp` |  |
| `asf_imp` | `./Tools/ASF_IMP/ASF_IMP.dsp` |  |
| `bin2cpp` | `./Tools/bin2cpp/bin2cpp.dsp` |  |
| `max2w3d` | `./Tools/max2w3d/max2w3d.dsp` |  |
| `pluglib` | `./Tools/pluglib/pluglib.dsp` |  |
| `wdump` | `./Tools/wdump/wdump.dsp` |  |

### `Code/ww3d2/hueshift/hueshift.dsw`

| Project | DSP path | Dependencies |
| --- | --- | --- |
| `skeleton` | `./hueshift.dsp` | ww3d2, wwmath, wwlib |
| `ww3d2` | `../ww3d2.dsp` |  |
| `wwlib` | `../../wwlib/wwlib.dsp` |  |
| `wwmath` | `../../wwmath/wwmath.dsp` |  |

### `Code/ww3d2/skeleton/sample.dsw`

| Project | DSP path | Dependencies |
| --- | --- | --- |
| `skeleton` | `./skeleton.dsp` | ww3d2, wwdebug, wwlib, wwmath |
| `ww3d2` | `../ww3d2.dsp` | wwdebug, wwlib, wwmath |
| `wwdebug` | `../../wwdebug/wwdebug.dsp` |  |
| `wwlib` | `../../wwlib/wwlib.dsp` |  |
| `wwmath` | `../../wwmath/wwmath.dsp` |  |

### `Code/ww3d2/sorttest/sorttest.dsw`
...
This manifest is descriptive. It preserves the original project names, paths, configurations, source lists, include paths, defines, link libraries, output paths, and workspace dependency edges. Modern build files should be derived from this manifest rather than hand-written from memory.
