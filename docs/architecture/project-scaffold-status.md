...
| `wwlib` | Win32 (x86) Static Library | platform | ✅ Built (filtered) — portable islands only; SDL3 thread + rawfile + rcfile opt-in | ✅ Built (filtered) — portable islands only; SDL3 thread + rawfile + rcfile opt-in |
