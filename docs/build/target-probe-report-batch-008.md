...
|---|---|---:|---:|---|---|
| `SControl` | Win32 (x86) Static Library | 4 | 0 | WinSock/network transport (56), threading/synchronization (4) | not built |
...
| `Scripts` | Win32 (x86) Dynamic-Link Library | 82 | 1 | old MSVC/C runtime spelling (95), threading/synchronization (15), Win32 window/message loop (4) | not built |
...
- Signal hits:
  - WinSock/network transport: 56 hit(s); examples: `Code/SControl/servercontrolsocket.cpp`, `Code/SControl/servercontrolsocket.h`, `Code/SControl/servercontrol.h`
  - threading/synchronization: 4 hit(s); examples: `Code/SControl/servercontrolsocket.cpp`, `Code/SControl/servercontrol.h`
...
- Signal hits:
  ...
  - old MSVC/C runtime spelling: 95 hit(s); examples: `Code/Scripts/Mission01.cpp`, `Code/Scripts/Mission11.cpp`, `Code/Scripts/Mission07.cpp`, `Code/Scripts/Mission04.cpp`, `Code/Scripts/Mission09.cpp`
